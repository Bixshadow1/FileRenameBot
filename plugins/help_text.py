    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Channel', url='https://t.me/mening_botlarim'),
                    InlineKeyboardButton('Feedback', url='https://t.me/zehnlibot')
                ],
                [
                    InlineKeyboardButton('Other Bots', url='https://t.me/mening_botlarim'),
                    InlineKeyboardButton('Ads', url='https://telegram.me/zehnlibot')
                ]
            ]
        ),
